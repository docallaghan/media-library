...
class GUI(tk.Tk):
    ...
    def __initialise_widgets(self):
        ...
        movies_tab = MediaTab(movies_frame)
...
class MediaTab:
    def __init__(self, master):
        ...
        # Columns
        self.table["columns"] = ("ID", "Title", "Album", "Artist")
...
# movies_frame = tk.Frame(window, width=w, height=h, bg="blue")
# games_frame = tk.Frame(window, width=w, height=h, bg="red")
# music_frame = tk.Frame(window, width=w, height=h, bg="green")
